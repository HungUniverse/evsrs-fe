...
import type {
  CarManufacture,
  CarManufactureRequest,
} from "@/@types/car/carManufacture";
import type { ItemBaseResponse, ListBaseResponse } from "@/@types/response";

export const CarManufactureAPI = {
  getAll: (pageNumber = 1, pageSize = 10) =>
    api.get<ListBaseResponse<CarManufacture>>("/api/CarManufacture", {
  ...
  update: async (
    id: string,
    data: CarManufactureRequest
  ): Promise<CarManufacture> => {
