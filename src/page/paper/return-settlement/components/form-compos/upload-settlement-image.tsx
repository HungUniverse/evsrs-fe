...
/** Upload ảnh lên Cloudinary (giống return) */
...
type Props = {
  label?: string;
  /** Lưu nhiều URL, ngăn cách bằng dấu phẩy (CSV) */
  value?: string | null;
  onChange?: (urlsCsv: string) => void;
  disabled?: boolean;
  /** Cho phép chọn nhiều file khi upload (mặc định: true) */
  multiple?: boolean;
};

export default function UploadSettlementImage({
