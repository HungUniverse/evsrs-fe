...
// function checkVerificationRequirements(
//   customer: Customer
...
// function canVerify(customer: Customer): {
//   canVerify: boolean;
...
//     missingRequirements.push("Thiếu ảnh CCCD hoặc GPLX");
//   if (!checklist.nameMatches)
//     missingRequirements.push("Tên không khớp với giấy tờ");
...
//   const [verifTarget, setVerifTarget] = useState<
...
//         (c) => c.verificationStatus === filters.verificationStatus
//       );
//     }
...
//             verifiedBy: currentUser?.name || currentUser?.name || "Unknown",
//             verifiedAt: now,
...
//         currentUser?.name || currentUser?.name || "Unknown";
...
//     action: "export" | "reject" | "lock" | "assign"
//   ) => {
...
//       bulkActionDialog.selectedCustomers.length === 0
//     )
//       return;
...
//               onValueChange={(v) =>
//                 setFilters((prev) => ({ ...prev, verificationStatus: v }))
//               }
//             >
...
//               onValueChange={(v) =>
//                 setFilters((prev) => ({ ...prev, riskLevel: v }))
//               }
//             >
...
//                 <SelectItem value="lastRentalDate-desc">
//                   Last rental (newest)
//                 </SelectItem>
//                 <SelectItem value="lastRentalDate-asc">
//                   Last rental (oldest)
//                 </SelectItem>
//                 <SelectItem value="totalViolations-desc">
//                   Violations (high)
//                 </SelectItem>
//                 <SelectItem value="totalViolations-asc">
//                   Violations (low)
//                 </SelectItem>
//                 <SelectItem value="totalRentals-desc">
//                   Rentals (high)
//                 </SelectItem>
...
//               const cccd = getDocStatus(
//                 Boolean(c.cccdImageUrl),
//                 c.verificationStatus
//               );
//               const gplx = getDocStatus(
//                 Boolean(c.gplxImageUrl),
//                 c.verificationStatus
//               );
//               return (
...
//                           <TooltipContent>
//                             {c.totalViolations > 0
//                               ? "Xem chi tiết vi phạm gần nhất trong hồ sơ"
//                               : "Không có vi phạm"}
//                           </TooltipContent>
//                         </Tooltip>
//                       </TooltipProvider>
...
//                     {/* Complaints */}
//                     <TableCell>
//                       {c.complaints?.filter((cm) => cm.status === "Pending")
//                         .length || 0}
//                     </TableCell>
//                     {/* Active */}
//                     <TableCell>
...
//       <Dialog
//         open={!!verificationDialog.customer}
//         onOpenChange={() =>
//           setVerificationDialog({ customer: null, action: "verify" })
//         }
//       >
...
//                   <img
//                     src={
//                       verificationDialog.customer.profilePicture ||
//                       "https://api.dicebear.com/7.x/initials/svg?seed=" +
//                         encodeURIComponent(verificationDialog.customer.fullName)
//                     }
...
//                       {verificationDialog.customer.fullName}
//                     </h3>
//                     <p className="text-sm text-muted-foreground">
//                       {verificationDialog.customer.userName}
//                     </p>
...
//                 <RadioGroup
//                   value={verifTarget}
//                   onValueChange={(v: "Pending" | "Verified" | "Rejected") =>
//                     setVerifTarget(v)
//                   }
...
//                     {verificationDialog.customer.verificationStatus ===
//                     "Rejected"
//                       ? "Checklist điều kiện để xác thực lại (tất cả cần đạt)"
//                       : "Checklist điều kiện (tất cả cần đạt)"}
//                   </h4>
//                   {(() => {
//                     const checklist = checkVerificationRequirements(
//                       verificationDialog.customer
//                     );
//                     const { missingRequirements, canVerify: ok } = canVerify(
//                       verificationDialog.customer
//                     );
//                     return (
//                       <div className="space-y-2">
//                         <div
//                           className={`flex items-center gap-2 p-2 rounded ${checklist.hasValidImages ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
//                         >
//                           {checklist.hasValidImages ? (
//                             <CheckCircle className="size-4" />
//                           ) : (
//                             <XCircle className="size-4" />
//                           )}
//                           <span className="text-sm">
//                             Có ảnh CCCD và GPLX hợp lệ
//                           </span>
//                         </div>
//                         <div
//                           className={`flex items-center gap-2 p-2 rounded ${checklist.nameMatches ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
//                         >
...
//                           )}
//                           <span className="text-sm">
//                             Tên/Ngày sinh khớp hồ sơ
//                           </span>
//                         </div>
//                         <div
//                           className={`flex items-center gap-2 p-2 rounded ${checklist.gplxValid ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
//                         >
//                           {checklist.gplxValid ? (
//                             <CheckCircle className="size-4" />
//                           ) : (
...
//                         </div>
//                         <div
//                           className={`flex items-center gap-2 p-2 rounded ${checklist.accountActive ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
//                         >
...
//                       Evidence URLs (mỗi link cách nhau bởi dấu phẩy)
//                     </Label>
//                     <input
...
//                         return !canVerify(verificationDialog.customer)
//                           .canVerify;
//                       }
//                       // Rejected
...
//                   Áp dụng cho {bulkActionDialog.selectedCustomers.length} khách
//                   hàng:
//                 </p>
...
//                 <div className="text-sm text-muted-foreground">
//                   Dữ liệu sẽ được xuất ra file CSV với tất cả thông tin khách
//                   hàng đã chọn.
//                 </div>
//               )}

//               {(bulkActionDialog.action === "reject" ||
//                 bulkActionDialog.action === "lock") && (
//                 <div className="space-y-2">
...
//                     </SelectTrigger>
//                     <SelectContent>
//                       <SelectItem value="ADM-001">
//                         Admin 001 - Nguyễn Văn A
//                       </SelectItem>
//                       <SelectItem value="ADM-002">
//                         Admin 002 - Trần Thị B
//                       </SelectItem>
//                       <SelectItem value="STF-003">
//                         Staff 003 - Lê Văn C
//                       </SelectItem>
//                       <SelectItem value="STF-004">
//                         Staff 004 - Phạm Thị D
//                       </SelectItem>
//                     </SelectContent>
//                   </Select>
//                   <textarea
